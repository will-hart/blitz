...
*/
  ...
  person: function() {
    ...
    return Blitz.Person.create({ id: personId });
  }.property().meta({ type: Blitz.Person })
  ```
...
*/
  ...
  ```javascript
  Blitz.MyCollectionView = Ember.CollectionView.extend({
...
*/
  ...
  ```javascript
  Blitz.Editable = Ember.Mixin.create({
    edit: function() {
  ...
  // .extend.
  Blitz.CommentView = Ember.View.extend(Blitz.Editable, {
    template: Ember.Handlebars.compile('{{#if isEditing}}...{{else}}...{{/if}}')
  });

  commentView = Blitz.CommentView.create();
...
*/
  ...
  ```javascript
  Blitz.Person = Ember.Object.extend({
    helloWorld: function() {
      alert("Hi, my name is " + this.get('name'));
    }
  });

  var tom = Blitz.Person.create({
    name: 'Tom Dale'
  });
  ...
  ```javascript
  var noName = Blitz.Person.create();
...
*/
  ...
  ```javascript
  Blitz.PaintSample = Ember.Object.extend({
    color: 'red',
  ...
  var paintSample = Blitz.PaintSample.create()
...
*/
  ...
  var goodGuy = Blitz.Person.create()
  ```
...
*/
  ...
  ```javascript
  Blitz.PersonView = Ember.View.extend({
...
*/
  ...
  ```javascript
  Blitz.SaveButtonView = Ember.View.extend(Ember.TargetActionSupport, {
...
*/
  ...
  ```javascript
  Blitz.Person = Ember.Object.extend(Ember.Evented, {
    greet: function() {
      // ...
      this.trigger('greet');
    }
  ...
  var person = Blitz.Person.create();
...
*/
  ...
  */
    ...
    ```javascript
    Blitz.BarView = Ember.View.extend({
      someNonConcatenatedProperty: ['bar'],
      classNames: ['bar']
    });

    Blitz.FooBarView = Blitz.BarView.extend({
      someNonConcatenatedProperty: ['foo'],
      classNames: ['foo'],
    });

    var fooBarView = Blitz.FooBarView.create();
    ...
    ```javascript
    var view = Blitz.FooBarView.create({
  ...
  */
    ...
    objects.
        ...
        Blitz.Person = Em.Object.extend()
        person = Blitz.Person.create()
        person.toString() //=> "<Blitz.Person:ember1024>"

    If the object's class is not defined on an Ember namespace, it will
    indicate it is a subclass of the registered superclass:

        Student = Blitz.Person.extend()
        student = Student.create()
        student.toString() //=> "<(subclass of Blitz.Person):ember1025>"

    If the method `toStringExtension` is defined, its return value will be
    included in the output.

        Blitz.Teacher = Blitz.Person.extend({
          toStringExtension: function(){
            return this.get('fullName');
          }
        });
        teacher = Blitz.Teacher.create()
        teacher.toString(); //=> "<Blitz.Teacher:ember1026:Tom Dale>"
...
*/
  ...
  ```javascript
  Blitz.PostsController = Ember.ArrayController.extend({
    itemController: 'post'
  });

  Blitz.PostController = Ember.ObjectController.extend({
  ...
  ```javascript
  Blitz.MyArrayController = Ember.ArrayController.extend({
    lookupItemController: function( object ) {
      if (object.get('isSpecial')) {
        return "special"; // use Blitz.SpecialController
      } else {
        return "regular"; // use Blitz.RegularController
      }
    }
  });
  ```
...
*/
  ...
  ```javascript
  Blitz.appController = Ember.Object.create({
  ...
  ```handlebars
  {{view Ember.ContainerView currentViewBinding="Blitz.appController.view"}}
  ```
  ...
  CustomCollectionView = Ember.CollectionView.extend({
    createChildView: function(viewClass, attrs) {
      if (attrs.content.kind == 'album') {
        viewClass = Blitz.AlbumView;
      } else {
        viewClass = Blitz.SongView;
      }
...
```javascript
Blitz.SaveButtonView = Ember.View.extend(Ember.ViewTargetActionSupport, {
  action: 'save',
  click: function(){
    this.triggerAction(); // Sends the `save` action, along with the current context
                          // to the current controller
...
*/
  ...
  ```handlebars
  {{#collection contentBinding="Blitz.items"}}
  ...
  ```javascript
  Blitz = Ember.Application.create()
  Blitz.items = [
  ...
  ```handlebars
  {{collection contentBinding="Blitz.items" itemViewClass="Blitz.AnItemView"}}
  ```
  ...
  Blitz.AnItemView = Ember.View.extend({
  ...
  ```handlebars
  {{#collection Blitz.MyCustomCollectionClass contentBinding="Blitz.items"}}
    Hi {{view.content.name}}
  {{/collection}}
  ```
...
*/
  ...
  ```handlebars
  {{#view Blitz.MyView }}
    {{each view.items itemViewClass="Blitz.AnItemView"}}
  {{/view}}
  ```
  ...
  ```javascript
  Blitz.DeveloperController = Ember.ObjectController.extend({
...
*/
  ...
  ```javascript
  Blitz.names = ["Yehuda", "Tom"];
  ```

  ```handlebars
  {{view Ember.Select contentBinding="Blitz.names"}}
  ```
  ...
  ```javascript
  Blitz.names = Ember.Object.create({
    selected: 'Tom',
    content: ["Yehuda", "Tom"]
  });
  ```
  ...
  ```handlebars
  {{view Ember.Select
         contentBinding="Blitz.names.content"
         valueBinding="Blitz.names.selected"
  }}
  ```
  ...
  update the value of `Blitz.names.selected` to "Yehuda".
  ...
  ```handlebars
  {{view Ember.Select
         contentBinding="Blitz.programmers"
  ...
  Blitz.currentProgrammer = Ember.Object.create({
    id: 2
  });
  ```
  ...
  {{view Ember.Select
         ...
         optionValuePath="content.id"
         optionLabelPath="content.firstName"
         valueBinding="Blitz.currentProgrammer.id"}}
  ```
  ...
  ('Yehuda') will update the `id` value of `Blitz.currentProgrammer`
  ...
  ```javascript
  Blitz.controller = Ember.Object.create({
    selectedPerson: null,
    content: [
      Ember.Object.create({firstName: "Yehuda", id: 1}),
      Ember.Object.create({firstName: "Tom",    id: 2})
  ...
  ```handlebars
  {{view Ember.Select
         contentBinding="Blitz.controller.content"
         optionValuePath="content.id"
         optionLabelPath="content.firstName"
         selectionBinding="Blitz.controller.selectedPerson"}}
  ```
  ...
  Interacting with the rendered element by selecting the first option
  ('Yehuda') will update the `selectedPerson` value of `Blitz.controller`
  to match the content object of the newly selected `<option>`. In this
  case it is the first object in the `Blitz.controller.content`
  ...
  {{view Ember.Select
         contentBinding="Blitz.controller.content"
         valueBinding="Blitz.controller.selected"
  }}
  ```
  ...
  Although `Blitz.controller.selected` is `null` and no `<option>`
...
*/
  ...
  `Blitz.ObjectController` and `Blitz.ArrayController`
*/
...
*/
  ...
  */
    ...
    The model for the `post` route is `Blitz.Post.find(params.post_id)`.
  ...
  */
    ...
    Blitz.PostRoute = Ember.Route.extend({
      model: function(params) {
  ...
  */
    ...
    * otherwise, the controller is an `Ember.ObjectController`.
    ...
    For the `post` route, a controller named `Blitz.PostController` would
  ...
  */
    ...
    Blitz.PostRoute = Blitz.Route.extend({
    ...
    * into the `main` outlet of the `application` template
    ...
    this case, the default model will be `Blitz.Post.find(params.post_id)`.
...
*/
  ...
  */
    ...
    into the `outlet` (e.g. `Blitz.PostsRoute` will render the `posts` template).
    ...
    ``` javascript
    Blitz.PostsRoute = Ember.Route.extend({
      renderTemplate: function() {
    ...
    ``` handlebars
    {{outlet viewClass=Blitz.SectionContainer}}
    ```

    ``` javascript
    Blitz.SectionContainer = Ember.ContainerView.extend({
      tagName: 'section',
      classNames: ['special']
    });
    ```
...
*/
    ...
    Ember.View.reopen({
      ...
      _hasEquivalentView: function(outletName, view) {
        ...
        return existingView && existingView.prototype === view.prototype && existingView.get('template') === view.get('template') && existingView.get('context') === view.get('context');
      },
...
*/
  ...
  * other names are looked up on the application after converting
    ...
    `Blitz.PostController` by default.
  * there are some nuances (see examples below)
  ...
  'controller:post' //=> Blitz.PostController
  'controller:posts.index' //=> Blitz.PostsIndexController
  'controller:blog/post' //=> Blog.PostController
  'controller:basic' //=> Ember.Controller
  'route:post' //=> Blitz.PostRoute
  'route:posts.index' //=> Blitz.PostsIndexRoute
  'route:blog/post' //=> Blog.PostRoute
  'route:basic' //=> Ember.Route
  'view:post' //=> Blitz.PostView
  'view:posts.index' //=> Blitz.PostsIndexView
  'view:blog/post' //=> Blog.PostView
  'view:basic' //=> Ember.View
  'foo:post' //=> Blitz.PostFoo
  ```
...
*/
  ...
  ```javascript
  window.Blitz = Ember.Application.create();
  ```
  ...
  ```javascript
  Blitz.MyView = Ember.View.extend();
  ```
...
*/
  ...
  */
      defaultRouter: function() {
        // Create a default Blitz.Router if one was not supplied to make
        // it possible to do Blitz.Router.map(...) without explicitly
  ...
  */
    ...
    ```javascript
    Blitz = Ember.Application.create();
    Blitz.deferReadiness();

    jQuery.getJSON("/auth-token", function(token) {
      Blitz.token = token;
      Blitz.advanceReadiness();
    });
    ```
  ...
  */
    ...
    Blitz.Person = Ember.Object.extend({});
    Blitz.Orange = Ember.Object.extend({});
    Blitz.Email  = Ember.Object.extend({});

    Blitz.register('model:user', Blitz.Person, {singleton: false });
    Blitz.register('fruit:favorite', Blitz.Orange);
    Blitz.register('communication:main', Blitz.Email, {singleton: false});
    ```
  ...
  **/
    ...
    ```javascript
    Blitz.inject(<full_name or type>, <property name>, <full_name>)
    Blitz.inject('model:user', 'email', 'model:email')
    Blitz.inject('model', 'source', 'source:main')
    ```
  ...
  */
      _initialize: function() {
        ...
        // At this point, the Blitz.Router must already be assigned
    ...
    test("first test", function(){
      // Blitz is freshly reset
    });

    test("first test", function(){
      // Blitz is again freshly reset
    });
    ```
  ...
  * other names are looked up on the application after classifying the name.
    For example, `controller:post` looks up `Blitz.PostController` by default.
...
*/
    ...
    ```javascript
    Blitz.CommentsController = Ember.ArrayController.extend({
      needs: ['post']
    });
    ```
    ...
    ```javascript
    this.get('controllers.post'); // instance of Blitz.PostController
    ```
...
*/
    ...
    `Blitz.injectTestHelpers` is called.
  ...
  */
    ...
    whenever `Blitz.injectTestHelpers` is called
